...
public class RNGaplessSoundModule extends ReactContextBaseJavaModule {

  Map<Integer, MediaPlayer> playerPool = new HashMap<>();
  ReactApplicationContext context;
  final static Object NULL = null;

  public RNGaplessSoundModule(ReactApplicationContext context) {
    super(context);
  ...
  public void prepare(final String fileName, final Integer key, final ReadableMap options, final Callback callback) {
    ...
    final RNGaplessSoundModule module = this;
